...
export default function ExperienciaProfissional() {
  return (
    <section className="bg-[#0f0f11] text-white py-16 px-6">
      <div className="max-w-6x1 mx-auto">
        <h2 className="text-center text-3x1 font-bold mb-2">
        ...
        <div className="bg-[##1b1b1e] rounded-2xl shadow-lg overflow-hidden">
          <div className="bg-gradient-to-r from-sky-600 p-6">
            <h3 className="text-x1 font-bold">MINISTÉRIO DO MEIO AMBIENTE E CLIMA</h3>
            <p className="text-sm">Estagio em Desenvolvimento de Sistemas</p>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-[#26262b] p-4 rounded-xl text-center">
                  <span className="block text-gray-300 font-bold">Power Bi</span>
                    <p className="text-sm text-gray-400">Power BI</p>
                </div>
                <div className="bg-[#26262b] p-4 rounded-xl text-center">
              ...
              <div className="mt-6">
                <a 
                  ...
                  px-4 py-2 rounded-2xl text-white text-sm transition"
                  >
