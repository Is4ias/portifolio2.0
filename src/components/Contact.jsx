...
const socialLinks = [
  ...
  {
    href: 'https://www.linkedin.com/in/isaiasribeiro2/',
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    href: "https://www.instagram.com/ias_rib02/",
...
const Contact = () => {
  return (
    ...
    >
        ...
        lg:items-stretch pt-20">
            <div className="mb-10 lg:mb-0 lg:flex lg:flex-col">
                ...
                <div className="flex items-center gap-2 mt-auto">
                    {socialLinks.map(({ href, icon, alt}, key) => (
                        ...
                        className="w-12 h-12 grid place-items-center ring-inset ring-2 
                                ring-zinc-800 text-white rounded-3xl transition-colors 
                                hover:bg-zinc-300 hover:text-zinc-950 active:bg-zinc-50/80 reveal-up"
                        >
                            {icon}
                        </a>
                    ))}
            ...
            <form 
            action="https://getform.io/f/aqoenrga" 
            method="POST"
            ...
            >
                ...
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-16">
                    ...
                    <div className="mb-4">
                        ...
                        autoComplete="email"
                        required 
                        placeholder="isaias02dev@gmail.com"
                        className="text-field reveal-up" />
                    </div>
                </div>
